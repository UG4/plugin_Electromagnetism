...
{
/// This type
	using this_type = NedelecLoopCurrent<TDomain, TAlgebra>;
...
///	Type of the attachment and its accessor for flags
	using a_edge_flag_type = AChar;
	using aa_edge_flag_type = Grid::EdgeAttachmentAccessor<a_edge_flag_type>;
	using a_vert_flag_type = ABool;
	using aa_vert_flag_type = Grid::VertexAttachmentAccessor<a_vert_flag_type>;
